...
class UserLogins
{
  public:
    struct Cols
    {
        ...
        static const std::string _logout_time;
    };
     ...
     */
    explicit UserLogins(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserLogins(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserLogins(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column logout_time  */
    ///Get the value of the column logout_time, returns the default value if the column is null
    const ::trantor::Date &getValueOfLogoutTime() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getLogoutTime() const noexcept;
    ///Set the value of the column logout_time
    void setLogoutTime(const ::trantor::Date &pLogoutTime) noexcept;
    void setLogoutTimeToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<UserLogins>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserLogins>;
#endif
    ...
    std::shared_ptr<::trantor::Date> logoutTime_;
    struct MetaData
    {
