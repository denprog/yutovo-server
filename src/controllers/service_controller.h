...
public:
    ...
    ADD_METHOD_TO(ServiceController::SaveDocument, "/service/save-document", Post); //save to DB
    ADD_METHOD_TO(ServiceController::LoadDocument, "/service/load-document", Post); //load from DB
    METHOD_LIST_END
