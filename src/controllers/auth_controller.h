...
public:
    ...
    ADD_METHOD_TO(AuthController::SendEmailMessage, "/auth/send-email", Post, "yutovo_server::LoginFilter");
    ...
    void SendEmailMessage(const HttpRequestPtr &req, std::function<void (const HttpResponsePtr &)> &&callback);
