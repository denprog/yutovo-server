...
public:
    ...
    ADD_METHOD_TO(SessionController::LibraryDocument, "/library/{1}", Get);
    ...
    void LibraryDocument(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)>&& callback, std::string param);
